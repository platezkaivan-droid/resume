...
const translations = {
    ...
    en: {
        ...
        about_p2: 'Built 8+ projects: a Telegram bot deployed on Render with Docker + CI/CD, a React Native mobile app with real-time chat, my own terminal VPN client, a Minecraft mod port (246 mixins), and 4 Fabric mods from scratch.',
